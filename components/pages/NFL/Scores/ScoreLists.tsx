    ...
    <div className="flex flex-col gap-4">
      {filteredGames.map((game) => (
        ...
        >
          ...
          {isDesktop && (
            <div className="grid grid-cols-2 gap-5 text-xs text-gray-700 space-x-3">
              {/* Left: Q1 & Q2 */}
              ...
              <div className="flex flex-col space-y-1">
                ...
                {/* Overtime (if exists) */}
                {game.scores.home.overtime !== null &&
                  game.scores.away.overtime !== null && (
                    <div className="flex space-x-2">
                      <span className="font-semibold">OT:</span>
                      <span
                        className={`font-semibold ${
                          game.scores.home.overtime > game.scores.away.overtime
                            ? "text-green-500"
                            : "text-red-500"
                        }`}
                      >
                      ...
                      <span
                        className={`font-semibold ${
                          game.scores.away.overtime > game.scores.home.overtime
                            ? "text-green-500"
                            : "text-red-500"
                        }`}
                      >
          ...
          <div className="text-xs text-gray-500 text-right w-32 ml-5">
            <Button
              variant={"default"}
              onClick={() => handleTopPlayersClick(game.game.id)}
            >
              Teams Stats
            </Button>
          </div>
